...
<form class="form-update-product" enctype="multipart/form-data">
    ...
    <div class="form-row">
        <div class="form-group col">
          ...
          <select id="hasVariations" class="form-control" name="hasVariations">
              <option value=""></option>
              <option value="1" @if($product->hasVariations == 1) selected @endif>Sim</option>
              <option value="0" @if($product->hasVariations == 0) selected @endif>Não</option>
          </select>
        </div>
        <div class="form-group col">
          ...
          <select id="hasAdditionals" class="form-control" name="hasAdditionals">
              <option value=""></option>
              <option value="1" @if($product->hasAdditionals == 1) selected @endif>Sim</option>
              <option value="0" @if($product->hasAdditionals == 0) selected @endif>Não</option>
          </select>
        </div>
        <div class="form-group col">
          ...
          <select id="canPrice" class="form-control" name="canPrice">
              <option value=""></option>
              <option value="1" @if($product->canPrice == 1) selected @endif>Sim</option>
              <option value="0" @if($product->canPrice == 0) selected @endif>Não</option>
          </select>
        </div>
    </div>
    @php
    ...
    <div class="content-variation-area mb-4">
