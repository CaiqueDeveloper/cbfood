    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Cb food <sup>beta</sup></div>
            </a>
            <!-- Divider -->
            ...
            align-items: center;">
                ...
                <img class="rounded-circle mb-2" src="@if(isset($response['user']['company']['pictureProfile']) > 0 ) /profile/{{$response['user']['company']['pictureProfile'][0]->path}} @endif" width="120px" height="120px">
                <div class="content-company-name" style="background: #fff;color:#000;font-weight:bold;padding: 5px 10px;text-align:center;border-radius:50px;width:max-content;">@if(isset($response['user']['company']) > 0 ){{$response['user']['company']->name}}@endif</div>
            </section><br>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Assinatura/Planos</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Nav Item -Companies Information -->
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle updataIdCompany" value="" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-building" style="color:#4e73df;font-size:1.5em"></i>
                                <p style="border-right: 1px solid #ddd;width:20px;height:35px;margin-top:15px;margin-left:7px;"></p>
                            </a>
                            <!-- Dropdown -Companies Information -->
                           
                            <div class="input-group mb-3 content-select-companies d-none mt-1" style="position: absolute;right:0;min-width:320px;z-index:1000">
                                <select class="custom-select col" id="chancheCompany">
                                    @foreach ($response['user']['companies'] as $company)
                                        <option value="{{$company->id}}" @if($company->id == $response['user']['company']->id) selected @endif style="cursor:pointer">{{$company->name}}</option>
                                    @endforeach
                                </select>
                              </div>
                         ...
                         <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="@if(isset($response['user']['pictureProfile']) > 0 ) /profile/{{$response['user']['pictureProfile'][0]->path}} @endif">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="/admin/profileUser">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                       <span>Copyright &copy; Cbsoftware {{date('Y')}}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
